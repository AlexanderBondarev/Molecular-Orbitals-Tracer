...
#set label "NH_2^+" at 16.8,-16.0 left font "Helvetica,28"
#set label "N_2" at 17.7,-16.0 left font "Helvetica,28"
#do for [i=4:20:1] { plot 'HF-B3LYP-SVP-MTMO-d009-809-n800-trace.csv' using 1:i with lines ls i lw 4 ti "i" }
plot 'HF-B3LYP-SVP-MTMO-d009-809-n800-trace.csv' using 2:4 with lines ls 1 lw 4 ti "1", \
 'HF-B3LYP-SVP-MTMO-d009-809-n800-trace.csv' using 2:5 with lines ls 2 lw 4 ti "2", \
 'HF-B3LYP-SVP-MTMO-d009-809-n800-trace.csv' using 2:6 with lines ls 3 lw 4 ti "3", \
 'HF-B3LYP-SVP-MTMO-d009-809-n800-trace.csv' using 2:7 with lines ls 4 lw 4 ti "4", \
 'HF-B3LYP-SVP-MTMO-d009-809-n800-trace.csv' using 2:8 with lines ls 5 lw 4 ti "5", \
 'HF-B3LYP-SVP-MTMO-d009-809-n800-trace.csv' using 2:9 with lines ls 6 lw 4 ti "6", \
 'HF-B3LYP-SVP-MTMO-d009-809-n800-trace.csv' using 2:10 with lines ls 7 lw 4 ti "7", \
